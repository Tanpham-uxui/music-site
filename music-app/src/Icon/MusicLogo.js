...
export const Home = ({fill, width, height}) => {
  return (
...
export const Album = ({fill, width, height}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" width={`${width ? width : 24}`} height={`${height ? height : 24}`}
           viewBox={`0 0 ${width} ${height}`}> fill="none">
...
export const Artist = ({strokeColor, fill, width, height}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" width={`${width ? width : 24}`} height={`${height ? height : 24}`}
           viewBox={`0 0 ${width} ${height}`}> fill="none">
        <path
...
export const Song = ({fill, width, height}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" width={`${width ? width : 24}`} height={`${height ? height : 24}`}
           viewBox={`0 0 ${width} ${height}`}> fill="none">
        <path
...
export const PlayList = ({fill, width, height}) => {
  return (
...
export const Heart = ({fill, width, height}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" width={`${width ? width : 24}`} height={`${height ? height : 24}`}
...
export const Podcast = ({fill, width, height}) => {
  return (
...
export const MagnifyingGlass = ({fill, width, height}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none"
           viewBox="0 0 48 48"
           width={`${width ? width : 24}`} height={`${height ? height : 24}`}
