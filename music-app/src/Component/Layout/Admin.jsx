...
function Admin() {
  ...
  const {tempThumbnail, thumbnail, audio, tempAudio} = state
  ...
  const handleAddNewMusic = (data) => {
    let newMusic = {
      ...data,
      audio:'ddd',
      thumbnail:'ddd'
    }
    dispatch(addNewMusicThunkAction(data))
      reset()
  }
  ...
  return (
      <>
        ...
        <form onSubmit={handleSubmit(handleAddNewMusic)}>
          <Stack direction={{xs: "column", sm: "row"}} spacing={2} alignItems="stretch" justifyContent="center" sx={{marginY:"1rem"}}>
              ...
              <FormControl>
                ...
                <Box>
                  <img role='button' width="100%" height="100%"
                       ...
                       src={thumbnailExample || tempThumbnail}
